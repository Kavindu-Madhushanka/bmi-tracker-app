          ...
          <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-5 mx-auto bg-white border max-w-7xl">
            ...
            <div className="items-center hidden gap-8 md:flex">
              <Link to="/" className="transition-colors hover:text-green-500">Home</Link>
                <Link to="/about" className="transition-colors hover:text-green-500">About</Link>
                <Link to="/contact" className="transition-colors hover:text-green-500">Contact</Link> 
            </div>

            <div className="flex items-center md:hidden">
                <button onClick={()=>setMenuStatus(!isMenuOpen)} className="text-gray-900 outline-none">
            ...
            {isMenuOpen && (
                ...
                <Link to="/" className="block transition-colors hover:text-green-500">Home</Link>
                <Link to="/about" className="block transition-colors hover:text-green-500">About</Link>
                <Link to="/contact" className="block transition-colors hover:text-green-500">Contact</Link> 
          ...
          <main className="flex items-center justify-center px-4 py-12">
            <div className="flex flex-col w-full max-w-5xl overflow-hidden bg-white shadow-2xl rounded-3xl md:flex-row">
                ...
                <div className="relative md:w-1/2 h-[400px] md:h-auto">
                    <img src={Girl} className="absolute inset-0 object-cover w-full h-full"/>
              ...
              <h2 className="mb-4 text-4xl font-bold">Your Health, Data-Driven.</h2>
              <p className="text-lg leading-relaxed text-gray-200">
                Join thousands of users tracking their progress and achieving their fitness goals with precision.
              </p>
            </div>
                 ...
                 <div className="max-w-md mx-auto">
                    ...
                    <p className="mb-8 text-gray-500">Enter your details below to start your journey.</p>
                ...
                <div>
                 ...
                 <button className="w-full bg-[#10f06f] text-gray-900 font-bold py-4 rounded-xl hover:bg-[#0ed963] transition shadow-lg shadow-emerald-200 mt-4">
                  Register
                </button>
                ...
                <p className="text-gray-600">
                  Already have an account? <Link to="/login" className="font-bold text-gray-800 hover:underline">Login</Link>
                </p>
              </div>
