      ...
      <aside className="fixed top-0 left-0 z-50 flex flex-col justify-between w-64 h-screen p-6 bg-white border-r">
        <div>
          ...
          <nav className="pt-8 gap-y-4">
            <button className="flex w-full p-3 rounded-lg border-1 hover:bg-green-400 hover:shadow-xl">
              <CiCalculator1 size={24} className="" />
              <p className="pl-2">Calculate BMI</p>
            </button>
            <button className="flex w-full p-3 rounded-lg border-1 hover:bg-green-400 hover:shadow-xl">
              <GoHistory size={23} className="" />
              <p className="pl-2">Your History</p>
            </button>
            <button className="flex w-full p-3 rounded-lg border-1 hover:bg-green-400 hover:shadow-xl">
        ...
        <div className="pt-6 border-top">
          <button className="flex items-center gap-3 mb-6 text-gray-500 transition hover:text-red-500">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-10 h-10 bg-green-400 rounded-full">
              <FaUserLarge size={24} className="text-gray-600" />
            </div>
            <div>
              <div>
                <span className="text-xl font-bold tracking-tight">
      ...
      <main className="flex-1 p-10 ml-64">
        <header className="mb-8">
          ...
          <p className="mt-2 text-gray-500">
            Enter your height and weight below to get your Body Mass Index
            result.
          </p>
        </header>
            ...
            <div className="p-8 bg-white border border-gray-100 shadow-sm rounded-3xl">
              ...
              <form>
                ...
                <button className="flex items-center justify-center w-full gap-2 py-4 mt-8 font-bold text-white transition bg-green-400 shadow-lg hover:bg-green-500 rounded-xl shadow-green-100">
                  <CiCalculator1 size={20} /> Calculate BMI
                </button>
              </form>
            </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-left text-gray-400 border-b border-gray-50">
                      <th className="pb-4 font-medium tracking-wider uppercase">
                        BMI Range
                      </th>
                      <th className="pb-4 font-medium tracking-wider uppercase">
                        Category
                  ...
                  <tbody>
                    {classifications.map((item, index) => (
                      <tr
                        key={index}
                        className={`${item.bg || ""} transition-colors`}
                      >
                        <td className="py-4 text-gray-600">{item.range}</td>
                        <td className={`py-4 font-semibold ${item.color}`}>
                          {item.category}
                        </td>
                      </tr>
                    ))}
          ...
          <div className="col-span-5 space-y-6">
            <div className="bg-[#0a110a] text-white p-8 rounded-[40px] relative overflow-hidden">
              <div className="flex items-start justify-between mb-8">
                ...
                <span className="text-[10px] bg-green-900 text-green-400 px-3 py-1 rounded-full font-bold">
                  LATEST RESULT
                </span>
              </div>
              ...
              <p className="flex items-center gap-2 mb-8 text-xl font-bold text-green-400">
                Normal Weight
                <span className="">
                  <FaCheck size={24} />
                </span>
              ...
              <div className="pt-6 mb-8 border-t border-gray-800">
                <p className="text-sm leading-relaxed text-gray-400">
                  Great job! Your BMI is within the healthy range of 18.5 to
                  24.9. Maintain your balanced diet and regular exercise.
                </p>
              </div>

              <div className="flex gap-4">
                <button className="flex-1 py-3 text-sm font-medium transition bg-gray-800 hover:bg-gray-700 rounded-xl">
                  Save Result
                </button>
                <button className="flex-1 py-3 text-sm font-medium transition bg-gray-800 hover:bg-gray-700 rounded-xl">
                  Share
